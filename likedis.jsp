...
<% 
    try {      
        ...
        String threadID = (String) request.getSession().getAttribute("tid");
       	...
       	ResultSet rs3 = stmt.executeQuery("select dislikes from post where postID= '"+pid+"'");
       	if(rs3.next()) {
            count = rs3.getInt("dislikes");
            count++;
			stmt.executeUpdate("update post set dislikes='"+count+"' where postID = '"+pid+"'");
