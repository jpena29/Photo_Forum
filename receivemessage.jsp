...
<html>
	...
	<%
	        	...
	        	ResultSet rs2 = stmt.executeQuery("select * from message where message.receive_username= '"+me+"'");
	        	
	        	if(rs2.next()) {
	     %>
	   
	     			<a href="openmsg.jsp?msgId=<% out.print(rs2.getString(1)); %>"><input type="button" value="<% out.print("Subject: "+rs2.getString(4)); %>"/></a>
		...
		<div id="searchmsg">
				<p><a href="search.html"><input type="button" value="Search"></a></p>
		</div>
	</body>
</html>